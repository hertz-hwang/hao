...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        items: [
          ...
          { text: '4.3 琉璃必拆字练习', link: '/bichai-liuli'},
          { text: '4.4 琉璃拆分查询', link: '/div-liuli' },
          { text: '============='},
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/hertz-hwang/hao' },
      {
        icon: {
          svg: `<svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tencent-qq" viewBox="0 0 16 16">
